...
public class AutoService {
    ...
    public Page<Auto> ConsultarAutos(int page, int size) {
        Pageable pageable = PageRequest.of(page, size, Sort.by("idauto").descending());
        return iAuto.findAll(pageable);
    }
    ...
    public Auto EditarAuto(int idauto, Auto autoUpdate) {
        ...
        if (autoOptional.isPresent()) {
            ...
            auto.setImagen(autoUpdate.getImagen());
